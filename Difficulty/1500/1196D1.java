...
public class Main {
	...
	public static void main(String[] args) {
        ...
        while(t-- > 0)
        {
            ...
            //I have next value of each;
            //I can start from 0 to n-k;
            int max = k-1;
            for(int i=0;i<=n-k;i++)
            {
                //Now I need to check value for each k;
                //int count = 0;
                int c1 = comp(hm,i,i+k,ch);
                max = Math.min(c1,max);
            }
    ...
    public static int comp(HashMap<Character,Character> hm, int i, int j,char ch[])
    {
        char n1='R';
        char n2='G';
        char n3='B';
