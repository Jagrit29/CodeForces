...
public class Main {
	...
	public static void main(String[] args) {
        ...
        while(t-- > 0)
        {
            ...
            //So I have zeros at i;
            HashSet<Integer> hs = new HashSet<>();
            for(int i=0;i<zeros.size();i++)
            {
                if(k==0) break;
                int index = zeros.get(i); //this is the index of ith zero;
                int need = index - i; //This much moves are needed;
                int mov = (int)Math.min(need,k); //This much moves I can make;
                hs.add(need-mov+i);
                k = k-mov;
            }
           // System.out.println(Arrays.toString(hs.toArray()));
            ...
            for(int i=0;i<n;i++)
            {
                ...
                else if(ch[i]=='0' && count<hs.size())
                {
                    //Zeros I have put ahead;
                    bf.append("1");
                    count++;
