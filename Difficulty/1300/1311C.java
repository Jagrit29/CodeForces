...
public class Main {
	...
	public static void main(String[] args) {
        ...
        while(t-- > 0)
        {
            ...
            {
                char c = ch[i];
                //calc mistakes after this index;
                int mistakesAfter = bs(a,i+1);
                //iske index ke baad kitni mistakes hai utni baar ye bdd jayega;
                int inc=(m-mistakesAfter);
                count[c-'a']++; //ek to hoga hi;
                if(mistakesAfter<0) continue;
                count[c-'a']+=inc;
            }
            for(int i: count)
            {
