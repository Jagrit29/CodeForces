...
public class Main {
	...
	public static void main(String[] args) {
        ...
        for(char c: ch)
        {
                if(c>='0' && c<='9') num = (int)(c-'0');
                if(c>='A' && c<='Z') num = ((int)(c-'A')+10);
                if(c>='a' && c<='z') num = ((int)(c-'a')+36);
                if(c=='-') num = 62;
                if(c=='_') num = 63;
             for(int i = 0;i<6;i++)
             {
            ...
            //Now this num should be bits of this num should same, like if its 1 I can have other pair to be only 1, else if its 0 I can have 3 numbers with 0 , 1,1;
