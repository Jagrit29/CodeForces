...
public class Main {
	...
	public static void main(String[] args) {
        ...
        //I have this max, I can divide it into two;
        List<Integer> list = new ArrayList<>();
        
        int sec = max/2; //this will be depth of other;
        
        int first = max - sec; //This will be depth of first;
        
        //When the depth increase first, I will point it two to;
        int curr = 0; //this is curr depth;
        for(char c: ch)
        {
            if(c=='(')
            {
