...
public class Main {
	...
	public static void main(String[] args) {
        ...
        int k = sc.nextInt();
        int l = sc.nextInt();
        int a[] = sc.nextIntArray(n*k);
        sort(a);
        //System.out.println(Arrays.toString(a));
        int min = a[0];
        int max = a[0]+l; //this is maxium I can have;
        int have = 0; //left from backside;
        //each group should have k elements;
        ...
        while(i>=0)
        {
            ...
            {
                //I can take this one, if have + this is equal to k or greater than k;
                if(have>=(k-1))
                {
                    sum = sum + a[i];
                    taken++;
