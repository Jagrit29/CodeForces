...
public class Main {
	...
	public static void main(String[] args) {
        ...
        //For minimum;
        long oneTeam = n/m ;
        long left = n%m; // left teams has n/m + 1 members;
        long ans1= (left*(oneTeam+1)*(oneTeam)/2) + (m-left)*(oneTeam*(oneTeam-1))/2;
        
        
        //for max;
        //I need to make m teams;
        //So there m-1 teams with 1 candidate;
        long twoTeam = (n-(m-1));
        long ans2 = twoTeam*(twoTeam-1)/2;
