...
static class Comp implements Comparator<Pair>
	...
	public static void main(String[] args) {
        ...
        //Now we get 2, now if I get 3 and then add all even numbers [2] I will get odd numbers some of which will be prime
        
        //if I have no 1 then I can get only 2;
        ...
        for(int i=0;i<twos;i++) list.add(2);
        for(int i=0;i<ones;i++) list.add(1);
