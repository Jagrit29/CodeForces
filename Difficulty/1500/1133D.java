...
public class Main {
	...
	public static void main(String[] args) {
        ...
        int n = sc.nextInt();
            ...
            //I am putting what I need in b[i];
            for(int i=0;i<n;i++)
            {
                b[i] = (long)(0-b[i]);
            }
            ...
            {
                //I have a[i];
                //I need to make it equal to b[i];
                //a[i]*d = b[i];
                if(a[i]==0 && b[i]==0)
                {
                    extra++;
                ...
                b[i] = b[i]/gcd;
                String form = b[i]+" "+a[i];
                //double d = (double)((b[i]*1.0)/a[i]);
                //String form = String.format("%.5f",d);
                //System.out.println(form);
                hm.put(form,hm.getOrDefault(form,0)+1);
                max = Math.max(hm.get(form),max);
            }
