...
public class Main {
	public static void main(String[] args) {
        ...
        while(t-- > 0)
        {
            ...
            //I have given maximum ones to all;
            //Now I will max to the smallest, one cause then it maybe considerend. coz smallest one will be considers in all, I need to considers as many maxim I can;
            for(int i=0;i<f;i++)
            {
                if(each[i]>0) 
                {
                    sum=sum+a[right-each[i]+1];
                    right = right-each[i];
                }
            }
