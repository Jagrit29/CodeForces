...
public class Main {
	public static void main(String[] args) {
        ...
        while(t-- > 0)
        {
            ...
            {
                int min1=Math.min(count[0],count[1]);
                int min2=Math.min(count[2],count[3]);
            ...
            else
            {
                ...
                {
                    //I cant have left and right;
                    int min=Math.min(count[2],count[3]);
                    if(min>0)
                    {
                ...
                {
                    int min=Math.min(count[1],count[0]);
                    if(min>0)
                    {
                        System.out.println(2);
