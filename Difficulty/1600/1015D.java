...
public class Main {
	public static void main(String[] args) {
        ...
        //Now I need to take k difference which sums to s;
        //so if s = 15, 15/2 is 7 but module is % mod is 1, so I can 1 others
        
        long min = s/k;
        long left = (s%k==0) ? 0 : s%k;
        long max = (left>0) ? min+1 : min;
        
        //Now I will need left times max;
        if(max>(n-1) || min==0)
        {
