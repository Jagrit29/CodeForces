...
public class Main {
    ...
    public static long solve1(long a[], long i,long dp[])
    {
        if(i>=a.length) return 0;
        int e = (int)i;
        //if(dp[e]!=-1L) return dp[e];
        long option1 = (long)(a[e] + (long)solve1(a,(long)(e+a[e]),dp));
        long option2 = (long)solve1(a,e+1,dp);
        
        return dp[e]=(long)Math.max(option1,option2);    
    }
    static class Pair
    {
        long x;
        ...
        //int i;
        public Pair(long x, long  y,long i)
        {
            this.x=x;
            this.y=y;
            this.i=i;
