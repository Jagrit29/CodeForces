	...
	public static void main(String[] args) {
        ...
        while(t-- > 0)
        {
            ...
            for(int i=0;i<n;i++)
            {
                if(ch1[i]!=ch2[i])
                {
                    list.add(i); //will change the element at i but will put it at first;
                    list.add(0); //will again change the ith element which we put at first;
                    list.add(i); //will change ith element and put that to i, rest elements are changed twice;
                    //Here we can see ith element is changed thrice;
