...
public class Main {
	public static void main(String[] args) {
       ...
       // System.out.println(currentSkill);
        ...
        //Now all are equal to multiple of 10;
        //Now I can add them ;
        long currSum = currentSkill*10; //this the curr sum;
        long max = n*100; //this can be the max;
        //I can add more;
        long add = Math.min(max - currSum, k);
        System.out.println((currSum + add)/10);
