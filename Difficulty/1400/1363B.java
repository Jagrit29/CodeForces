...
public class Main {
	...
	public static void main(String[] args) {
        ...
        while(t-- > 0)
        {
            ...
            //to make all zeros;
            max = Math.min(max, ones); //number of ones, I need to make zero;
            
            //to make all ones;
            max = Math.min(max, zeros); //Making all zeros as ones;
            ...
            for(char c: ch)
            {
                ...
                //making 000011111
                max = Math.min(max, onesDone + (zeros-zerosDone));
                
                //making 1111100000;
                max = Math.min(max, zerosDone + (ones-onesDone));
