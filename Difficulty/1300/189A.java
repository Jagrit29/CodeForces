...
public class Main {
	...
	public static void main(String[] args) {
        ...
        hm=new HashMap<>();
        System.out.println(Math.max(1,solve(n,a[0],a[1],a[2])));
    ...
    public static int solve(int n, int a,int b,int c)
    {
        ...
        int op1 = 1+solve(n-a,a,b,c);
        int op2 = 1+solve(n-b,a,b,c);
        int op3 = 1+solve(n-c,a,b,c);
        hm.put(n,Math.max(op1,Math.max(op2,op3)));
        return hm.get(n);
    }
