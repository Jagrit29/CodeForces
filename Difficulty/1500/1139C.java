...
public class Main {
	...
	public static void main(String[] args) {
        ...
        for(int i=0;i<n;i++)
        {
            ...
            graph.get(i).add(i); //self loop in each;
        }
        int mod = (int)Math.pow(10,9)+7;
        long total = (long)power(n,k,mod);  //n^k % mod;
        //System.out.println(total);
        //This graph will only contain edges with all red colors;
        for(int i=0;i<n-1;i++)
        {
            int u = sc.nextInt()-1;
            int v = sc.nextInt()-1;
        ...
        for(int i=0;i<n;i++)
        {
            ...
            {
                int sizeOfGroup = dfs(graph,i,visited,0);
                //System.out.println(sizeOfGroup);
                allRed = (allRed + power(sizeOfGroup,k,mod))%mod;
            }
        }  
        System.out.println((total - allRed + mod)%mod);
    }
    /*
    Why I need to add mod;
...
Which will be positive. Hence we have to add the mod in negative number until it becomes positive.
    ...
    */
    public static int dfs(List<List<Integer>> graph, int i, HashSet<Integer> visited,int size)
    {
        ...
        for(int ne : neigh)
        {
            ...
            {
                size = dfs(graph,ne,visited,size);
            }
        }
        return size;
    }
